            ...
            if n[Notify.YOLO] == True and n[Notify.GPT4] == False and n[Notify.QUESTION] == False:
                ...
                try:
                    client.upload_fileobj(
                        memory, bucket_name, f"OriginalBot/received/{os.path.basename(file_info.file_path)}")
                ...
                self.bot.send_message(
                    msg.chat.id, "For now I can only handle messages not photos,\nif you want to detect objects in photos refer to /help .")
                n[Notify.GPT4] = False
                ...
                self.bot.send_message(
                    msg.chat.id, "It seems you tried to upload a photo, if you want to detect objects got to /help\nand choose object detection")
        ...
        def back(clk):
            if clk.message:
                ...
                if clk.data == 'answer_gpt4':
                    ...
                    self.bot.send_message(
                        clk.message.chat.id, "You are now chatting with gpt-4,to quit use /quit")
    ...
    def text_handler(self):
        ...
        def txt(msg):
            ...
            if notify.get(Notify.GPT4):
                ...
                feed_to_dynamo_update = dynamo_obj.convert_regular_dictionary_to_dynamodb(
                    chat_history)
