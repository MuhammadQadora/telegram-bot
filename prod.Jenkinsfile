    ...
    stage('Build Docker Image and push to ECR'){
      steps{
         container(name: 'kaniko', shell: '/busybox/sh'){
          ...
          sh '''#!/busybox/sh
            cd Original-bot
            /kaniko/executor --context `pwd` --destination 933060838752.dkr.ecr.us-east-1.amazonaws.com/original-bot:$v
            /kaniko/executor --context `pwd` --destination 933060838752.dkr.ecr.us-east-1.amazonaws.com/original-bot:latest
          '''
         } 
      }
    }
